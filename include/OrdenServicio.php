            ...
            <div class="box-header">
                ...
                <div class="box-tools">
                    <div class="input-group input-group-sm hidden-xs" style="width: 150px;">
                        <input type="text" name="BuscarOrder" class="form-control pull-right" placeholder="Search">
                        <div class="input-group-btn">
                            <button type="submit" name="BuscarOrdenS" class="btn btn-default"><i class="fa fa-search"></i></button>
                        </div>
                    </div>
                </div>
            </div>
